...
class TournamentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tournament" do
    assert_difference('Tournament.count') do
      post tournaments_url, params: { tournament: { date: @tournament.date, name: @tournament.name } }
    end
  ...
  test "should update tournament" do
    patch tournament_url(@tournament), params: { tournament: { date: @tournament.date, name: @tournament.name } }
